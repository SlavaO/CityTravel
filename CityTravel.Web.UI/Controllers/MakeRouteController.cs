...
namespace CityTravel.Web.UI.Controllers
{
    ...
    public class MakeRouteController : BaseController
    {
        ...
        /// </summary>
        /// <param name="routeSeach">
        /// The route seach. 
        /// </param>
        public MakeRouteController(IRouteSeach routeSeach)
        {
        ...
        public JsonResult Index( MakeRouteViewModel makeRouteViewModel, ValidateServer validateCoords )
        {
			//if (validateCoords.IsValid(makeRouteViewModel))
		//	{
				...
				var allRoutes = this.routeSeach.GetAppropriateRoutes(endPoint.ToSqlGeography(), startPoint.ToSqlGeography(), args);
