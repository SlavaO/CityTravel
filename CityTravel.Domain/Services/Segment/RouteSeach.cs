...
namespace CityTravel.Domain.Services.Segment
{
    ...
    public class RouteSeach : IRouteSeach
    {
        ...
        /// </summary>
        private readonly IProvider<Route> routeRepository;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RouteSeach"/> class.
        /// </summary>
        /// <param name="unitOfWork">The unit of work.</param>
        public RouteSeach(IUnitOfWork unitOfWork)
        {
            this.routeRepository = unitOfWork.RouteRepository;
        }
            ...
            IEnumerable<Transport> transportTypes)
        {
            ...
            IEnumerable<Route> defineRoutes = this.GetRoutes(transportTypes, this.routeRepository.All(), startMarker, endMarker);
        ...
        {
            var result = (length / ((speed * Kilometer) / Hour)) + waitingTime;
