...
namespace CityTravel.Domain.Services.Autocomplete
{
    ...
    public class Autocomplete : IAutocomplete
    {
        ...
        /// The unit of work. 
        /// </param>
        public Autocomplete(IUnitOfWork unitOfWork)
        {
            this.placeRepository = unitOfWork.PlaceRepository;
            this.buildingRepository = unitOfWork.BuildingRepository;
        }
        ...
        /// The suggestions. 
        /// </param>
        public void AddSuggestionsToDatabase(List<string> suggestions)
        {
        ...
        public object GetAdressFromDatabase(string inputAdress)
        {
            ...
            acceptebleWords.ForEach(
                str =>
                placesToFindStreetFromBeginingOfTheWord.AddRange(
                    this.placeRepository.Filter(e => e.Name.Contains(str))));
